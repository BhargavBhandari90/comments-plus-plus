...
if ( ! class_exists( 'Comment_Plus_Plus_Admin_Main' ) ) {

	/**
	 * Class for fofc core.
	 */
	class Comment_Plus_Plus_Admin_Main {
		...
		public function bwp_cpp_settings_page() {
			add_menu_page(
				esc_html__( 'Comment Plus Plus Settings', 'comment-plus-plus' ),
				esc_html__( 'Comment Plus Plus', 'comment-plus-plus' ),
				'manage_options',
				'comment-plus-plus',
	...
	new Comment_Plus_Plus_Admin_Main();
}
